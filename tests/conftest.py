...
# SQLALCHEMY_DATABASE_URL = 'postgresql://postgres:Andrey17042004333@localhost:5432/fastapi_test'
...
def test_user2(client):
    user_data = {"email": "andy123@gmail.com", "password": "password123"}
...
def test_user(client):
    user_data = {"email": "andy@gmail.com", "password": "password123"}
